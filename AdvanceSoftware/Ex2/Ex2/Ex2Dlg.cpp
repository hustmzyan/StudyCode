...
CEx2Dlg::CEx2Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_EX2_DIALOG, pParent)
{
...
BOOL CEx2Dlg::OnInitDialog()
{
	...
	HINSTANCE DllHandle1 = LoadLibrary(L"MyDLL1.dll");
	HINSTANCE DllHandle2 = LoadLibrary(L"MyDLL2.dll");
	HINSTANCE DllHandle3 = LoadLibrary(L"MyDLL3.dll");
	if (DllHandle1) {
